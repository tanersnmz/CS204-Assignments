/*******************************************************************************************************************
Purpose: 
This program is a simplified version of an IT system for a taxi company where two or more drivers share a car.
(Purpose for student: To understand how to share objects between class by using reference variables)
